...
> = {
  ...
  good: { bg: "bg-secondary", text: "text-muted-foreground", label: "Good" },
...
export function GameSummary({
  ...
  return (
    <div className="stagger-children flex flex-col gap-6">
      {/* Accuracy section */}
      <Card className="border-border bg-card/60 hover-lift">
        ...
        <CardContent>
          <div className="flex items-center justify-center gap-8">
            <div className="flex flex-col items-center gap-1">
              ...
              />
              {whiteRating != null && (
                <span className="mt-1 rounded-md bg-secondary px-2 py-0.5 text-[10px] font-medium text-foreground/90">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <p className="text-xs font-medium text-foreground/90">White</p>
            ...
            {/* Black */}
            <div className="space-y-2">
              <p className="text-xs font-medium text-foreground/90">Black</p>
              <div className="flex flex-wrap gap-1.5">
                {blackCounts.map((c) => (
                  <ClassificationBadge
                    key={c.classification}
            ...
            <div className="space-y-2">
              {keyMoments.map((moment) => (
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-md px-2 py-1.5 text-left transition-colors hover:bg-secondary"
                >
