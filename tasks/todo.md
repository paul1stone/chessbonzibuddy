...
- [x] Wave 5: Task 8 98fa26c (3 sound script deviations; found poster-ghost bug, fixed in 3031f42; review in flight)
- [ ] Wave 6: Task 9 e2e + build verification (in flight, 9 tests incl. poster-unmount regression)
